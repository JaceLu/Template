    ...
    $this.uploadifive({
        ...
        onUploadComplete: function (file, data) {
            ...
            if (result.IsSuccess) {
                ...
                var $ele = $group.find("input[type=hidden]");
...
$(function () {
    ...
    $("body").on("keyup", "#toolbar input[name=key]", function (event) {
        if (event.keyCode === 13)
...
function btnUpload(tmpl, element, parent, buttonText) {
    ...
    if (!parent)
        parent = $(element).closest(".zqui-form__element");
...
function getFileTmpl(api) {
    ...
    return {
        ...
        ViewTmp: $.templates("<div class=\"zqui-upload__item\">                                    <div class=\"zqui-upload__bd\">                                        <a class=\"zqui-upload__name\">{{>DisPlayName}}</a>                                    </div>                                    <div class=\"zqui-upload__ft\">                                        <a class=\"zqui-text_green\" href=\"/api/" + api + "/DownLoad?id={{>FileDbId}}\">\u4E0B\u8F7D</a>                                    </div>\n                                </div>"),
...
var ChooseModal = /** @class */ (function (_super) {
    __extends(ChooseModal, _super);
    function ChooseModal(config) {
        ...
        _this.page = new Sail.Pagination(cfg);
        _this.modal.on("click", ".btnReset", function () {
            that
                .find(".toolbar")
                .ResetForm();
            that.page.Query(1);
    ...
    ChooseModal.prototype.find = function (selector) {
        return this.modal.find(selector);
    };
    ChooseModal.prototype.choose = function (data) {
        return true;
    };
    return ChooseModal;
}(Sail.Modal));
